            ...
            <div className="mt-4" style={{ opacity: resultsOutOfDate ? 0.5 : 1 }}>
              ...
              {results.length > 1 && (
                <Alert variant="success" className="mb-3">
                  <strong>💰 Great news!</strong> You could save about <strong>${(results[1].totalCost - results[0].totalCost).toLocaleString()}</strong> this year by choosing {results[0].planName}.
                </Alert>
              )}
